<template>
  <div class="outDiv">
    <div style="margin-bottom:20px">
      <el-radio-group v-model="building" size="small">
        <el-radio-button label="3号楼"></el-radio-button>
        <el-radio-button label="A栋"></el-radio-button>
        <el-radio-button label="C栋"></el-radio-button>
        <el-radio-button label="D栋"></el-radio-button>
        <el-radio-button label="7号楼"></el-radio-button>
        <el-radio-button label="9号楼"></el-radio-button>
        <el-radio-button label="12号楼"></el-radio-button>
      </el-radio-group>
    </div>
    <div class="searchBar">
    ...
    <div>
      <el-tabs v-model="allTableObj.currentTab" @tab-click="tabClick($event)">
        ...
        <el-tab-pane label="1层" name="one"></el-tab-pane>
        <el-tab-pane label="2层" name="two"></el-tab-pane>
        <el-tab-pane label="3层" name="three"></el-tab-pane>
        <el-tab-pane label="4层" name="four"></el-tab-pane>
