<template>
  <div class="outDiv">
    <div class="searchBar">
      ...
      <div>
        <el-button size="mini" type="primary" @click="add">添加入院登记</el-button>
      </div>
    </div>
    <div>
